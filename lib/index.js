...
function paginate(argOpts) {
    ...
    // --------------------------------------------------------------------------------------------------------
    var opts = argOpts || {};
    opts.baseCssClass = 'baseCssClass' in opts ? opts.baseCssClass : '';
    ...
    // begin
    var paginationClasses = opts.baseCssClass ? ' ' + opts.baseCssClass : '';
    html.push('<ul class="pagination'+ paginationClasses  +'">');
